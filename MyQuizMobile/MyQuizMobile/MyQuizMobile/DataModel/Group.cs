...
namespace MyQuizMobile.DataModel {
    public class Group : MenuItem {
        ...
        // BUG: following routes do not work until backend fixes them
        public static async Task<Group> Get(int i) { return await App.Networking.Get<Group>($"api/groups/{i}"); }
        public static async void Delete(Group g) { await App.Networking.Delete($"api/groups/{g.Id}"); } 
    }
}